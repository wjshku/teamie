...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigateToCreate }) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="pt-12 sm:pt-16 lg:pt-20 pb-8 sm:pb-10 lg:pb-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-muted via-background to-muted/50">
      ...
      {/* Solution Section */}
      <section className="pt-8 sm:pt-10 lg:pt-12 pb-12 sm:pb-16 lg:pb-20 px-4 sm:px-6 lg:px-8 bg-card">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-card-foreground mb-8 lg:mb-10">
            {t('landing.solution.title')}
          </h2>

          <div className="grid gap-6 lg:gap-8 md:grid-cols-1 lg:grid-cols-3">
