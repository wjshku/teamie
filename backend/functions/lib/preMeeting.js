 ...
 */
router.get('/:meetingId/preMeeting', async (req, res) => {
    try {
 ...
 */
router.post('/:meetingId/preMeeting', async (req, res) => {
    try {
        const { meetingId } = req.params;
 ...
 */
router.patch('/:meetingId/preMeeting/objective', async (req, res) => {
    try {
        const { meetingId } = req.params;
 ...
 */
router.post('/:meetingId/preMeeting/questions', async (req, res) => {
    try {
        const { meetingId } = req.params;
...
//# sourceMappingURL=preMeeting.js.map