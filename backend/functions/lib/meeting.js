...
router.post('/', async (req, res) => {
    try {
        ...
        const meetingData = {
            ...
            status: 'scheduled',
            time: '',
            participants: [{ id: uid, name: (userData === null || userData === void 0 ? void 0 : userData.name) || '', avatar: (userData === null || userData === void 0 ? void 0 : userData.avatar) || '' }], // 临时用户对象，后续会从数据库获取完整信息
            votelink: '',
            createdBy: uid,
            createdAt: new Date(),
            updatedAt: new Date()
